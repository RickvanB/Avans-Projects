...
public class BankOverview extends JPanel {

	private static final String OPENRM = "Open de bank";
	...
	private final static int OPENSIZE_M_OVERVIEW_WIDTH = 450;
	...
	public BankOverview(int gameID) {
	...
	protected void paintComponent(Graphics g) {
		...
		if (this.getOveriewIsOpen()) {
			ResultSet result = this.b.getRawMaterials();
			Color c = null;
