...
describe('AuthCompanyGuard', () => {
  ...
  it('should return false when user not logged in', inject([AuthCompanyGuard], (guard: AuthCompanyGuard) => {
  ...
  it('should return true when user logged in', inject([AuthCompanyGuard], (guard: AuthCompanyGuard) => {
    /* tslint:disable */
